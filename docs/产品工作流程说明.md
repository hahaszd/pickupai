...
登录查看详情：https://pickupai.ai-builders.space/dashboard
```
...
**后台地址：** `https://pickupai.ai-builders.space/dashboard/login`
...
| **部署方式** | Docker / AI Builder Space（Koyeb）—— 已上线：`https://pickupai.ai-builders.space` |
| **本地开发隧道** | ngrok |
...
- **生产环境**：以 Docker 容器形式部署在 AI Builder Space（Koyeb）上 —— 当前已上线：`https://pickupai.ai-builders.space`
