...
登录查看详情：https://getpickupai.com.au/dashboard
```
...
| **部署方式** | Docker / AI Builder Space（Koyeb）—— 已上线：`https://getpickupai.com.au` |
| **本地开发隧道** | ngrok |
...
- **生产环境**：以 Docker 容器形式部署在 AI Builder Space（Koyeb）上 —— 当前已上线：`https://getpickupai.com.au`
